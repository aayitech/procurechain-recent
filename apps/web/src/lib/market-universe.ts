...
const aliases: Record<string, string[]> = {
  BRENT: ['Brent crude'], WTI: ['WTI crude'], NATURAL_GAS: ['Natural gas'], COPPER: ['Copper'], ALUMINUM: ['Aluminium'], ALUMINIUM: ['Aluminium'], WHEAT: ['Wheat'], CORN: ['Corn / maize'], SUGAR: ['Sugar'], IRON_ORE: ['Iron ore'], COAL: ['Coal'], GOLD: ['Gold'],
};
