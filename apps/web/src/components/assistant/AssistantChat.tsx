        ...
        onError: (error) => {
          const message =
            (error as Error).message?.includes('not configured')
              ? "The AI Assistant isn't configured on this backend (missing GEMINI_API_KEY) — this only works when the API server is running with a key set."
