...
type BriefSignal = { key: string; name: string; value: number; unit: string; change7d: number | null; change30d: number | null; history: Array<{ asOf: string; price: number }>; href: string };
